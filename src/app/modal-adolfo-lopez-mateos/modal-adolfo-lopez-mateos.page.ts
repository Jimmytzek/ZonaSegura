...
@Component({
  selector: 'app-modal-adolfo-lopez-mateos',
  templateUrl: './modal-adolfo-lopez-mateos.page.html',
  styleUrls: ['./modal-adolfo-lopez-mateos.page.scss'],
})
export class ModalAdolfoLopezMateosPage implements OnInit {
